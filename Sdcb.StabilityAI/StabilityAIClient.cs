...
public class StabilityAIClient : IDisposable
{
    ...
    public async Task<Artifact[]> GenerateImageFromTextAsync(ImageGenerationOptions options, string engineId = "stable-diffusion-xl-beta-v2-2-2", CancellationToken cancellationToken = default)
    {
